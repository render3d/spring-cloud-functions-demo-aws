...
public class SnapStartLambdaFactory {

    private SnapStartLambdaFactory() {}
    ...
    public static Function createFunction(
            final Stack stack, final String functionName, final String moduleName, final Map<String, String> envVars) {
